...
from .consumers import VideoConsumerTestedEdition, VideoSessionConsumer, JSONSessionConsumer, PoseDetectionConsumer
...
websocket_urlpatterns = [
    ...
    path('ws/pose_session/<uuid:session_id>/', PoseDetectionConsumer.as_asgi()),
